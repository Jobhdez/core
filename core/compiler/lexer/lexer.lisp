...
(alexa:define-string-lexer python-lexer
  ...
  ("print"    (return (tok :print (intern (string-upcase $@) "CORE-VAR"))))
  ("def"      (return (tok :def (intern (string-upcase $@) "CORE-VAR"))))
  ("\\:"      (return (tok :colon)))
  ("\\;"      (return (tok :semicolon)))
  ("{{NAME}}" (return (tok :name (intern (string-upcase $@) "CORE-VAR"))))
