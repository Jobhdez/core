...
(defun expose-allocation (tup)
  (match tup
	 ((tuple :int elements)
	  (make-begin :statements (flatten (list (mapcar (lambda (element) (make-temp-variable element)) elements)
					...
					(mapcar (lambda (e) (make-array-variable e)) (mapcar (lambda (element) (make-temp-variable element)) elements))))))))
